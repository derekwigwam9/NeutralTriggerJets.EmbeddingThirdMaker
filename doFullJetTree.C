...
void doFullJetTree(unsigned long nEvents=2000000000,char* outFile1="thirdJetMakerTest.root",char* fName = "/projecta/projectdirs/starprod/embedding/production2009_200GeV/Jet_pp200_2009.elz17/SL11d_embed/10120093/pt15_25_10120093_1.MuDst.root") //100
{ 
  ...
  gSystem->Load("/global/project/projectdirs/star/pwg/starjetc/dmawxc/Embedding/Run9pp/ThirdJetMaker/.sl64_gcc482/lib/libStJetTreeThirdMaker.so");
  ...
  StDetectorDbMaker* detDbMk=0;
   ...
   StIOMaker* ioMaker = 0;
    ...
    if(inputFile.EndsWith(".list"))
      inputDir.Prepend("@");
/* Shouldn't this have been commented out? ------------------------------------
