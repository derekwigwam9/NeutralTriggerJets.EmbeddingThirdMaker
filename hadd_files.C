...
static const Int_t nFiles = 426;


void MergeRootfile( TDirectory *target, TList *sourcelist );
//void hadd_files( const char, const char);


void hadd_files( TString filelist= "file.list", TString outputrootfiles ="test.root")
//void hadd_files()
{
  ifstream files;
  ...
  //  Target = TFile::Open( "pp_test_1.root", "RECREATE" ); 
